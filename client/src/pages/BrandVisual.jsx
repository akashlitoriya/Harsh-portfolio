  ...
  return (
    loading ? (<Loader />) :(
      ...
      <div className='w-max mt-6 md:mt-10'>
          <h1 className='text-white text-xl sm:text-3xl lg:text-4xl w-fit tracking-wider font-Montserrat font-semibold uppercase  px-10 py-5 bg-white bg-opacity-5 rounded-lg'>Brand Visual</h1>
