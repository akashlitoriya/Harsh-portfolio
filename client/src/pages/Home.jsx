      ...
      <div className=' w-11/12 sm:w-fit mr-0 sm:mr-28 mb-0 sm:mb-28  flex flex-col md:flex-row sm:items-center shadow-custom-inset bg-white bg-opacity-5 rounded-xl px-4 py-8 md:px-10 md:py-10 backdrop-blur-md  z-50'>
        <div className='flex flex-col gap-3 md:gap-6 justify-center'>
          <div>
            ...
            <motion.h1 className='w-full font-extrabold font-Montserrat text-4xl lg:text-5xl uppercase tracking-wider text-center' initial={{opacity:0, y:-50}} whileInView={{opacity:100, y:0}} transition={{delay:0.3, duration:0.2}}>Mandloi</motion.h1>
          </div>
          <motion.div className='w-full flex flex-row justify-center md:justify-start items-center gap-5 font-Montserrat text-center text-gray-300 text-lg lg:text-2xl font-semibold mb-4 md:mb-0 whitespace-nowrap' initial={{opacity:0}} whileInView={{opacity:100}} transition={{delay:0.4, duration:0.2}}>
            <span className='uppercase w-full text-center'>CGI Artist</span>
          </motion.div>
        ...
        <motion.div className='z-50 sm:hidden' initial={{'opacity':0, x:-100}} whileInView={{'opacity':100, x:0}} transition={{"delay":0.6, duration:0.3}}>
