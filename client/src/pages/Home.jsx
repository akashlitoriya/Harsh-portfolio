...
const Home = () => {
  return (
    <div className=' w-full h-max min-h-screen text-white text-5xl font-bold flex justify-center items-center snap-start relative'>
      {/* Container  */}
      <div className='w-11/12 md:w-4/5 sm:min-h-[500px] lg:w-fit flex flex-col md:flex-row items-center shadow-custom-inset bg-white bg-opacity-5 rounded-xl px-4 py-8 md:px-10 md:py-10 backdrop-blur-md  z-50'>
