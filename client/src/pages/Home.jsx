...
const Home = () => {
  return (
    <div className=' w-full h-max min-h-screen text-white text-5xl font-bold flex justify-center items-center snap-start relative'>
      {/* Container  */}
      <div className='w-4/5 lg:w-fit flex flex-col md:flex-row items-center bg-white bg-opacity-5 rounded-xl px-10 backdrop-blur-xl  border-b-4 border-text_secondary z-50'>
        <div className='flex flex-col gap-3 md:gap-6'>
          ...
          <motion.div className='w-full flex flex-row justify-center md:justify-start items-center gap-5 font-Montserrat text-center text-gray-500 text-lg lg:text-2xl font-semibold mb-4 md:mb-8' initial={{opacity:0}} whileInView={{opacity:100}} transition={{delay:0.4, duration:0.2}}>
            <span>3D Artist</span>
